...
export class LipidProfileAnalyzer implements IClinicalTrendAnalyzer {
  readonly metric = METRICS.LIPID_PROFILE;

  supports(metric: string): boolean {
    return metric === METRICS.LIPID_PROFILE;
  }
